...
router.delete('/collection/:collectionId', Middlewares.Validate(getLayersSchema), Controllers.UserController.deleteCollection);
router.post('/addLayer', Middlewares.Validate(addLayerSchema), Controllers.UserController.addLayer);
...
router.post('/generateNFT', Middlewares.Validate(generateNFTSchema), Controllers.UserController.generateNfts);
